# mycode (Dr.Frankenstein)

This code will be learning at the same rate as its creater so it can go on to solve world problems or just a nice place to store notes. I will be leaving most all the notes that came with this template in order to be more structured during the configuration and creation of this code.
...
* **Eddie Lerma** - *Initial work* - [YourWebsite](https://example.com/)
